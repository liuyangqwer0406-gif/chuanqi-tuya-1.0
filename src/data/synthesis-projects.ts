    ...
    chapters: [
      {
        ...
        images: [
          ...
          image("packaging-blanket/blanket-01-hero.webp", "LUNA HOME 柔软羊羔绒毛毯电商主图海报", "Soft Teddy Blanket", "Hero visual / E-commerce", "board"),
          image("packaging-blanket/blanket-02-benefits.webp", "羊羔绒毛毯核心卖点与四维特性分析", "Core benefits", "Product highlights", "board"),
          image("packaging-blanket/blanket-03-material.webp", "羊羔绒织物绒毛触感与包边微距工艺细节", "Material detail", "Fabric craftsmanship", "board"),
          image("packaging-blanket/blanket-04-lifestyle.webp", "客厅沙发日常休闲居家生活氛围体验", "Lifestyle scene", "Living room context", "board"),
          image("packaging-blanket/blanket-05-sizeguide.webp", "毛毯尺寸规格对照表与版型匹配指南", "Size guide", "Dimensions & fit", "board"),
          image("packaging-blanket/blanket-06-colours.webp", "六款流行色系陈列矩阵（驼/米白/卡其/鼠尾绿/脏粉）", "Available colours", "Six colourways", "board"),
          image("packaging-blanket/blanket-07-care.webp", "机洗维护指南与高耐用度功能标签", "Care & function", "Maintenance guide", "board"),
          image("packaging-blanket/blanket-08-comfort.webp", "香薰暖光与慢节奏治愈空间氛围呈现", "Cozy everyday comfort", "Spatial atmosphere", "board"),
